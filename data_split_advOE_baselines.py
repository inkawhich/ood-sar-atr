...
for hld_id, hld in enumerate(hld_groups):
    ...
    for ITER in range(REPEAT_ITERS):
        ...
        for dd in range(1,len(DATASETS)):
            ...
            print("\tBaseline.          AUROC: {:.4f}. TNR@95TPR: {:.4f}. AUOUT: {:.4f}".format(
            ...
            print("\tODIN (T=1000).     AUROC: {:.4f}. TNR@95TPR: {:.4f}. AUOUT: {:.4f}".format(
                metric_results['TMP']['AUROC'],
                metric_results['TMP']['TNR'],
                metric_results['TMP']['AUOUT'],
            ))
            ...
            print("\tMahalanobis.       AUROC: {:.4f}. TNR@95TPR: {:.4f}. AUOUT: {:.4f}".format(
                metric_results['TMP']['AUROC'],
                metric_results['TMP']['TNR'],
                metric_results['TMP']['AUOUT'],
            ))
            ...
            print("\tODIN (T=1000) IPP. AUROC: {:.4f}. TNR@95TPR: {:.4f}. AUOUT: {:.4f}".format(
                metric_results['TMP']['AUROC'],
                metric_results['TMP']['TNR'],
                metric_results['TMP']['AUOUT'],
            ))
            ...
            print("\tMahalanobis IPP.   AUROC: {:.4f}. TNR@95TPR: {:.4f}. AUOUT: {:.4f}".format(
                metric_results['TMP']['AUROC'],
                metric_results['TMP']['TNR'],
                metric_results['TMP']['AUOUT'],
            ))
    ...
    with open('advOE_baseline_k0_j3_stats_dropP3_GausP3_LmbP5_run0.pickle', 'wb') as f:
        pickle.dump({'acc':STAT_accuracy, 'ood': STAT_ood,
                     'holdout_groups': running_hld_groups, 'time': STAT_time}, f)
