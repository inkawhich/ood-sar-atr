...
for cls_method in CLS:
    for holdout in range(10):
        ...
        for ITER in range(REPEAT_ITERS):
            ...
            splits = create_split.create_dataset_split(
                dataset_root, K, holdout_classess)
            ID_trainlist, ID_testlist, OOD_testlist, bce_weights = splits
            ID_train_loader, ID_testloader, OOD_testloader = \
            ...
            STAT_accuracy[cls].append(final_test_acc)
            net.eval()
