...
for cls_method in CLS:
    for holdout in range(10):
        ...
        id_classes = list(range(10))
        id_classes.remove(holdout)
        for ITER in range(REPEAT_ITERS):
            ...
            for submod in range(10-NUM_HOLDOUT_CLASSES):
                ...
                splits = create_split.create_bce_dataset_splits(
                    dataset_root, K, holdout_classes, submod)
                ID_trainlist, ID_testlist, OOD_testlist = splits
                ID_trainloader, ID_testloader, OOD_testloader = \
                    create_split.get_data_loaders(
                        ID_trainlist, ID_testlist, OOD_testlist,
